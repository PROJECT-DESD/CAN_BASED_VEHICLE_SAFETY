  ...
  while (1)
  {
	  //mc38 actuator(buzzer)
	  	  	 ...
	  	  	 //lm393 actuator(LED)
	  	  	  ...
	  	  	  //lm35 actuator (DC Fan)
	  	  	 if(flag[2]==1){
	  		  		 HAL_GPIO_WritePin(GPIOD, GPIO_PIN_1, SET);
	  		  		 lcd16x2_i2c_2ndLine();
	  		  		 lcd16x2_i2c_printf("DC FAN ON");
	  	  	 }
	  	  	 else{
	  	  	 ...
	  	  	 //HW-028 rain drop sensor actuator (servo motor)
	  	  	 if(flag[3]==1){
	  	  		 HAL_GPIO_WritePin(GPIOE, GPIO_PIN_9, SET);
	  	  		lcd16x2_i2c_1stLine();
	  	  		 lcd16x2_i2c_printf("SERVO MOTOR ON");
	  	  	  }
	  	 	  else{
